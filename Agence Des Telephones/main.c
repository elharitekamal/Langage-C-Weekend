    ...
    if ( age >= 18){
        ...
        switch(budg){
            case 1: printf("Voila Nos Promotions Actuelles Pour ce Budget : Samsung A10   //  IPhone 6s  // Infinix Hot 10 // Huawei Y6 :\n");
                    ...
                    scanf(" %d", &phone);
                    switch(phone){
                        case 1: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Samsung A10 .\n", pren, nom, ville, num);
                        break;
                        case 2: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le IPhone 6s .\n", pren, nom, ville, num);
                        break;
                        case 3: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Infinix Hot 10 .\n", pren, nom, ville, num);
                        break;
                        case 4: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Huawei Y6 .\n", pren, nom, ville, num);
                        break;
            ...
            case 2: printf(" Voila Nos Promotions Actuelles Pour ce Budget : Iphone 7   //  Redmi 9t  // Huawei 9s // Iphone 8 : \n");
                    ...
                    scanf(" %d", &phone);
                    switch(phone){
                        case 1: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Iphone 7 . \n", pren, nom, ville, num);
                        break;
                        case 2: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Redmi 9t . \n", pren, nom, ville, num);
                        break;
                        case 3: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Huawei 9s .\n", pren, nom, ville, num);
                        break;
                        case 4: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Iphone 8 .\n", pren, nom, ville, num);
                        break;
                        default: ("Merci de bien lire les commandes et redemarrer le Programme pour ressayer une autre fois\n");
                        }
                        break;
            case 3: printf(" Voila Nos Promotions Actuelles Pour ce Budget : Iphone X   //  Iphone XR  // Redmi note 10 // Iphone 11 .: \n");
                    ...
                    scanf(" %d", &phone);
                    switch(phone){
                        case 1: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Iphone X .\n", pren, nom, ville, num);
                        break;
                        case 2: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Iphone XR .\n", pren, nom, ville, num);
                        break;
                        case 3: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Redmi note . 10 \n", pren, nom, ville, num);
                        break;
                        case 4: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Iphone 11 .\n", pren, nom, ville, num);
                        break;
                        default: ("Merci de bien lire les commandes et redemarrer le Programme pour ressayer une autre fois . \n");
                        } break;
            case 4: printf(" Voila Nos Promotions Actuelles Pour ce Budget : Iphone 11 pro   //  Sumsung Ultra 11  // Iphone 13 // Iphone 13 pro .:\n");
                    ...
                    scanf(" %d", &phone);
                    switch(phone){
                        case 1: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le phone 11 pro .\n", pren, nom, ville, num);
                        break;
                        case 2: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Sumsung Ultra 11 .\n", pren, nom, ville, num);
                        break;
                        case 3: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Iphone 13 . \n", pren, nom, ville, num);
                        break;
                        case 4: printf(" Donc C'est Monsieur %s %s de %s , on vous appelera sur %d pour confirmer ta commande pour le Iphone 13 pro . \n", pren, nom, ville, num);
                        break;
                        default: ("Merci de bien lire les commandes et redemarrer le Programme pour ressayer une autre fois \n");
                        }
                        break;
